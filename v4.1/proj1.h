...
enum {
  ...
  DUTY_CYCLE_RANGE = 2000,   // the range of the duty cycle peroids (msecs)  between motes
  ...
  QUERY_INT = 5,           // query time interval, the time between neighboring node
